// Quick manual test for encoding/decoding changes
// This verifies that Step 1.1 changes work correctly

class TestCKBService {
  ...
  test() {
    console.log("Testing Step 1.1: Hash Encoding/Decoding without timestamp\n");
...
const tester = new TestCKBService();
tester.test();